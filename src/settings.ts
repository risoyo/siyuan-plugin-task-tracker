...
function showHelpDialog(): void {
  ...
  <ul>
    ...
    <li><strong>日历</strong>：按计划开始日期展示任务，可展开未安排任务浮层，并按月份真实需要自适应 5 行或 6 行。</li>
    <li><strong>已完成</strong>：按任务完成时间所在自然周分组，标题显示为 <code>YYYY年WeekN(MM.DD~MM.DD)</code>，支持导出每周周报，可重新打开或删除任务。</li>
  </ul>

  <h2>六、完成、删除与归档</h2>
  <p>顶层任务标记为已完成后，会自动移动到 <code>事项库/已完成/&lt;周起始日&gt;</code>，按任务完成时间所在自然周归档，例如 <code>事项库/已完成/2026-05-11</code>。已完成页可把该周任务导出到 <code>事项库/周报</code>，重复导出只会重建“本周工作事项”部分。子任务单独完成时会保持在父任务下；历史的月归档目录不会被批量迁移或删除。</p>
